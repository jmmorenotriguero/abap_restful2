CLASS lhc_Booking DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    METHODS get_instance_features FOR FEATURES IMPORTING keys REQUEST
...
CLASS lhc_Booking IMPLEMENTATION.
  ...
  METHOD validateStatus.
    ...
    READ ENTITY z_i_travel_jmt\\Booking
...
RESULT DATA(lt_booking_result).
    LOOP AT lt_booking_result INTO DATA(ls_booking_result).
      CASE ls_booking_result-booking_status.
        ...
        WHEN 'B'. " Booked
        WHEN OTHERS.
          APPEND VALUE #( %key = ls_booking_result-%key ) TO
          failed-booking.
          ...
          '008'
          v1 =
          ls_booking_result-booking_id
          severity =
          if_abap_behv_message=>severity-error )
          %element-booking_status =
          if_abap_behv=>mk-on ) TO reported-booking.
      ENDCASE.
    ENDLOOP.
